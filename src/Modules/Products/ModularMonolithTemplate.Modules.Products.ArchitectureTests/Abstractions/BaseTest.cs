...
namespace ModularMonolithTemplate.Modules.Products.ArchitectureTests.Abstractions;
...
public abstract class BaseTest
{
    ...
    protected static readonly Assembly InfrastructureAssembly = typeof(Infrastructure.ProductsModule).Assembly;
