...
public class ModularMonolithTemplateApiTests : IClassFixture<ModularMonolithTemplateApiFixture>
{
    private readonly HttpClient _httpClient;

    public ModularMonolithTemplateApiTests(ModularMonolithTemplateApiFixture fixture)
    {
